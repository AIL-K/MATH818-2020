...
\end{equation}
	...
	Put the function of purpose $k=y - \frac{1}{x}$. $y = \frac{1}{x} +k$, $y = -0.9 x+2.4$
	
	$k=y-\frac{1}{x}$ has the form of graph as illustrated as blue graphs. The graph should be on the region, or some point on the graph should also be on the region. Combining these two conditions, we can conclude that in order to maximize $k$, the graph should be as high  as possible about $y$-axis, meeting the region. Since $y = \frac{1}{x}+k$ has derivative $y' = -\frac{1}{x^2}$ on $(0,\infty)$, we can conclude that there exists some $(x,y)$ such that $y' = -0.9$. That is, there exists $k$ such that $y = \frac{1}{x} + k$ tangent to $y=-0.9x +2.4$. By calculations, we can get that two graphs meet at $(\frac{\sqrt{10}}{3}, -\frac{3\sqrt{10}}{10}+2.4)$. Then we conclude that maximum $k=\frac{19}{20}+2.4$
